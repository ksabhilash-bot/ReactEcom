    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Choose your preferred delivery location</p>
            ...
            >
              <CardContent className="space-y-4">
                ...
                <div className="pt-4">
                  <button
                    onClick={() =>
                      handleOrder({ userId: userId, addressId: item._id, cartId: fetchdata._id })
                    }
        ...
        <div className="mt-12">
          ...
          {fetchdata.items && fetchdata.items.length > 0 && (
            <div className="mt-6 text-right">
              <button
                onClick={() => handleCancelOrder({ userId: userId, cartId: fetchdata._id })}
